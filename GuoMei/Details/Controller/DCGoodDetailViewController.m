...
-(void)setUpChildViewControllers
{
    ...
    DCGoodsParticularsViewController *goodParticularsVc = [[DCGoodsParticularsViewController alloc] init];
    [self addChildViewController:goodParticularsVc];
    
    DCGoodsCommentViewController *goodCommentVc = [[DCGoodsCommentViewController alloc] init];
