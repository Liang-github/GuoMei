...
#import "DCSlideBarView.h"
#import "DCFiltrateViewController.h"

#define AnimatorDuration 0.25

@interface DCSlideBarView ()<UIGestureRecognizerDelegate>

@property (nonatomic, strong) UIView *coverView;
@property (nonatomic, strong) DCFiltrateViewController *filterView;

@end
@implementation DCSlideBarView
...
+ (void)dc_showSildBarViewController{
    DCSlideBarView *obj = [[DCSlideBarView alloc]initWithFrame:CGRectMake(0, 0, ScreenW, ScreenH)];
