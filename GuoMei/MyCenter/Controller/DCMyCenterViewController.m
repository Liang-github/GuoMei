...
@property (nonatomic, strong) DCMyCenterHeaderView *headView;

@property (nonatomic, strong) UIImageView *headerBgImageView;

@property (nonatomic, strong) UITableView *tableView;

@property (nonatomic, strong) DCCenterTopToolView *topToolView;

@property (nonatomic, strong) NSMutableArray<DCGridItem *> *serviceItem;
